...
<head>
    ...
    <title>Manager : Forget Sign</title>
...
<div class="m-2 flex flex-col w-auto h-auto justify-center items-center">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="forget/recover.php" method="post" accept-charset="UTF-8">
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                Login
            </label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Login" value="<?php if($login != ''){echo $login;} ?>" name="login">
        </div>
        <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                Codigo Recuperação
            </label>
            <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="" name="recover">
            <p class="text-red-500 text-xs italic">Please choose a recover code.</p>
        </div>
        <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                New Password
        ...
        <div class="flex items-center justify-center">
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" name="rec">
                Recover
            </button>
        </div>
    </form>
